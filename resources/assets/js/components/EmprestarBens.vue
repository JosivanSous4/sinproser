            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="m-portlet">
                        ...
                        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" v-on:submit.prevent="registrarEmprestimo">
                            <div class="m-portlet__body">
                                ...
                                <div class="table-responsive col-md-12 form-group m-form__group">
                                    <br>
                                    <h5 class="msg-emprestar-bem text-center">Selecione apenas os que deseja <span class="danger">EMPRESTAR</span></h5>
                    ...
                    <div class="m-portlet">
                        ...
                        <div class="m-portlet__body">
                            <form  v-on:submit.prevent="registrarEmprestimo">
                                <div class="row col-md-12 margin-zero padding-zero">
                                    <div class="row col-md-12 form-group">
                                        <h5 class="titulo-emprestar-conhecido">Caso queira emprestar para um conhecido:</h5>
                                    </div>
                                    <div class="row col-md-12 padding-zero">
                                        <div class="col-lg-4 form-group">
                                            <label>
                                                Selecione o Associado
                                            </label>
                                            <select id="associado_id" class="form-control m-input m-input--square" v-model="associado_selecionado" name="associado_id">
                                                <option value="">Selecione o associado</option>
                                                <option v-for="associado in listaAssociados" :value="associado.associado_id">
                                                    {{ associado.nome }}
                                                </option>
                                            </select>
                                        </div>

                                        <div class="col-lg-2 form-group margin-top-25">
                                            <button type="button" @click="getAssociado()" class="btn btn-primary">Obter informações</button>
                                        </div>
                                        ...
                                        <div class="col-lg-4 form-group">
                                            ...
                                            <select id="associado_id" class="form-control m-input m-input--square" v-model="responsavel_selecionado" name="associado_id">
                                                <option value="">Selecione o responsavel</option>
                                                <option v-for="responsavel in listaResponsaveis" :value="responsavel.responsavel_id">
                                                    {{ responsavel.nome_responsavel }}
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-lg-2 form-group margin-top-25">
                                            <button type="button" @click="getResponsavel()" class="btn btn-primary">Obter informações</button>
                                        </div>
                                    </div>
                                    <span>IMPORTANTE: Caso o responsável seja alguém que não está listado, preencha as informações abaixo manualmente</span>
                                </div>
                                <hr>
                                <div class="row form-group">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" required maxlength="120" :class="'form-control m-input '" v-model="emprestimo.dados_responsavel.nome_responsavel" placeholder="Digite o nome completo">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" required v-input-mask data-inputmask="'mask': '999.999.999-99'" v-model="emprestimo.dados_responsavel.cpf_responsavel" :class="'form-control m-input '" placeholder="CPF">
                                        <div class="invalid-feedback">
                                            <!-- {{errors.cpf}} -->
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" required name="data_prevista_devolucao" v-model="emprestimo.data_prevista_devolucao" class="form-control m-input" placeholder="Digite o nome completo">
                                    </div>
                                </div>
                                <endereco ref="endereco" :dados="dados_responsavel"  :errors="form_errors" class="row m-form__group"></endereco>
                                <contatos ref="contatos" :dados="dados_responsavel" :errors="form_errors" class="row m-form__group"></contatos>

                                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                                    <div class="m-form__actions m-form__actions--solid">
                                        <div class="row">
                                            <div class="col-lg-12 m--align-right">
                                                <template v-if="emprestimo.qtde_emprestar > 0">    
                                                    <button type="submit" class="btn btn-primary">
                                                        {{ btn.action }}
                                                    </button>
                                                </template>
                                                <template v-else>    
                                                    <button type="button" class="btn btn-primary disabled" title="Selecione no mínimo um ítem para emprestar">
                                                        {{ btn.action }}
                                                    </button>
                                                </template>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            registrarEmprestimo : function() {
                self = this;
                self.getEndereco();
                self.getContatos();

                self.salvarDados(this.titulo + '?', this.urlRequest, this.emprestimo);
            },
            ...
            checkEdit : function() {
                ...
                if (this.dados) {
                    ...
                    this.emprestimo.produto_id    = dados.produto_id;
                    ...
                    this.titulo = 'Realizar empréstimo';

                    this.btn.action = "Registrar Empréstimo";
                    this.btn.icon   = "fa fa-check";
                } else {
                    this.btn.action = "Realizar empréstimo";
                    this.btn.icon   = "fa fa-check";
                }
            },
        },
