                ...
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            ...
                            <li class="m-portlet__nav-item">
                                <a :href="urlBase+'/configuracoes/gerenciar-site/diretor/form-diretor'" class="m-portlet__nav-link btn btn-accent m-btn m-btn--pill m-btn--air">
                                    <span>
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped- table-bordered table-hover table-checkable">
                            ...
                            <tbody>
                                <tr v-for="diretor in diretores.data">
                                    ...
                                    <td class="align-middle">
                                        {{diretor.created_at | date}}
                                    </td>
                                    <td nowrap="" style="" class="text-center align-middle">
                                        <a :href="urlBase+'/configuracoes/gerenciar-site/diretor/form-diretor/'+diretor.diretor_id" v-tooltip="'Editar diretor'" class="btn btn-primary m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill btn-sm">
                                            <i class="flaticon-edit"></i>
                                        </a>
                                        <button type="button" v-tooltip="'Excluir diretor'" v-if="per == 1" @click="excluirParceiro(diretor)" class="btn btn-danger m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill btn-sm">
                    ...
                    <pagination v-if="diretores.data" class="justify-content-center" :data="diretores" @pagination-change-page="getDiretores">
    ...
    export default {
        ...
        methods : {
            ...
            excluirParceiro : function(parceiro) {
                self = this;
                let url = urlBase+"/configuracoes/gerenciar-site/diretor/excluir-diretor";
                let retorno;
                Swal({
            ...
            getDiretores: function(page = 1) {
                self = this;
                let url = '';
                if (!this.diretores.data) {
                    url = urlBase+"/api-site/diretores?page=" + page;
                }else {
                    url = this.diretores.path+"?page=" + page;
                }
                self.$http.get(url).then((response) => {
                    self.diretores = response.body;
                }, response => {
                    return self.$swal({
