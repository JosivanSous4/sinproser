 ...
 */
class ReciboLocacaoPessoaJuridira implements HtmlToPdf
{
                               ...
                               <div class='col-md-7 col-xs-9 col-p-10'>
                                   <div class='row'>
                                       ...
                                       <p class='recuo'>
                                           ...
                                           declarar que recebi a quantia de <b>R$ {$this->recibo->valor}</b> de <b>{$this->recibo->representante->nome}</b>, portador do CPF: <b>{$this->recibo->representante->cpf}</b> e RG: <b>{$this->recibo->representante->rg}</b>, representante da Pessoa Jurídica <b>{$this->recibo->empresa->nome}</b>,
                                           sob CNPJ <b>{$this->recibo->empresa->cnpj}</b>, localizado à cidade {$this->recibo->empresa->endereco->cidade}, bairro {$this->recibo->empresa->endereco->bairro}, Rua {$this->recibo->empresa->endereco->rua}, N° {$this->recibo->empresa->endereco->numero}, 
